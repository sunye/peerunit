...
import fr.inria.peerunit.freepastrytest.test.AbstractFreePastryTest;
...
public class SimpleTest extends AbstractFreePastryTest {
    ...
    public void put() throws InterruptedException, RemoteException{
        for (int i = 0; i < 2; i++) {
    ...
    public void get() throws InterruptedException, RemoteException{
        // Lookup
