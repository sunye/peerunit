...
/**
 *  FilteringFunction test with a set of 5 negative bacteria 
 */
public class FilteringFunctionTestNegativeBacteria extends TestCase {
	...
	public void testFilterSecondGeneralCase(){
		...
		testBactAlg.filter();
		assertTrue(
				((DummyBacterium)testBactAlg.getBacteriologicMedium().get(0)).getNumber() == -2 &&
				((DummyBacterium)testBactAlg.getBacteriologicMedium().get(1)).getNumber() == -4 &&
