...
public class BAT0PaperGen {
	...
	public static void main(String[] args) {
		...
		String Directory="/Users/freddy/Documents/workspaces/thesis_projects/mdca/ExperimentalDataContainer/paper/";
		...
		try {
			m=reader.readModel(new File(Directory+"paperM.txt"));
		} catch (IOException e) {
	...
	/*	try {
			writer.write(ba.getSolution().getInstanceSet(), new File(Directory+"paperInstance.txt"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}*/
	/*	for(BaseInstance i:ba.getSolution().getInstanceSet()){
			for(int v:i.getValues()){
				System.out.print(v+",");
			}
			System.out.print("\n");
		}*/
