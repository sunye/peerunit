...
public class AllPairs
{
  ...
  public static void main(String[] s) throws IOException
  {
    ...
    System.out.println("MaxGoes " + maxGoes + " seed " + seed +
      " noShuffle " + noShuffle);
    AllPairs.indefiniteGenerate(choices, seed, maxGoes, !noShuffle,
      tran);
  }
  // Check function for Galois Field based constructions
  static void gfCheck(int maxPower)
  {
