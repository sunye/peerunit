 ...
 *
 */
public class TestQueryTheorem extends TesterImpl{
	...
	public static void main(String[] str) {		
		test = new TestQueryTheorem();
		test.export(test.getClass());		
		// Log creation
		FileHandler handler;
		try {
			System.out.println("NAME "+test.getPeerName());
			handler = new FileHandler(TesterUtil.getLogfolder()+"/TestQueryTheorem.log.peer"+test.getPeerName(),true);
