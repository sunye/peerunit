 ...
 *
 */
public class TestPeerIsolationNew extends TesterImpl{
	private static Logger log = Logger.getLogger(TestPeerIsolationNew.class.getName());

	private static final int OBJECTS=TesterUtil.getObjects();

	static TestPeerIsolationNew test;
