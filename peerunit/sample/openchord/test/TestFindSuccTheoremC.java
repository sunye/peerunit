...
public class TestFindSuccTheoremC extends TesterImpl{
	...
	public static void main(String[] str) {		
		test = new TestFindSuccTheoremC();
		test.export(test.getClass());		
		// Log creation
		FileHandler handler;
		try {
			System.out.println("NAME "+test.getName());
			handler = new FileHandler(TesterUtil.getLogfolder()+"/TestFindSuccTheoremC.log.peer"+test.getName(),true);
