...
public class RemoteObjectProvider_Socket implements RemoteObjectProvider,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.univnantes.alma.rmilite.server.RemoteObjectManager#getPort(java.rmi.Remote)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * fr.univnantes.alma.rmilite.server.RemoteObjectManager#isExported(java.rmi.Remote)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.univnantes.alma.rmilite.server.RemoteObjectManager#remoteProcedureCall(int,
	 * fr.univnantes.alma.rmilite.io.RemoteProxy)
	 */
	@Override
