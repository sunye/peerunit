...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("--> Connection SSH reussie avec la machine "+ ip +" : "+connect);
...
//        System.out.println("--> Connection des fichiers de configuration sur la machine "+m.getIp()+" : "+result);
        ...
        /** D�compression du fichier JAR contenant les fichiers de configuration avec le package de gridbus ***/
