...
public class QVMinimization {
	public static void main(String[] args) throws InvalidConfigurationException {
		...
		//set a minimization comparator, the default is a maximization comparator
		configuration.getFitness().setComparator(new MinimizationDominanceComparator());
		Gene[] sampleGenes = new Gene[2];
		sampleGenes[0] = new DoubleGene(configuration,-5,5);
		sampleGenes[1] = new DoubleGene(configuration,-5, 5);
