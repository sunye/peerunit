...
public class TestInconclusiveArray  extends TesterImpl{
	...
	public static void main(String[] str) {
		...
		test = new TestInconclusiveArray();
		...
		try {
			...
			handler = new FileHandler("/tmp/almeida/TestInconclusiveArray.log.peer"+test.getName(),true);
